...
const providerAssetVersion = "20260603-native-click-fallback";
[
  "styles.css",
  "spots-db.js",
  "app.js",
...
expectIncludes(contents.readme, "layer membership, pin-tier visibility", "README documents local native debug bridge layer and pin-tier telemetry");
...
expectIncludes(contents.readme, "layer membership and pin-tier visibility", "README documents native layer membership and pin-tier visibility");
...
expectIncludes(contents.docs, "20260603-native-click-fallback", "strategy doc mentions provider cache version");
...
expectIncludes(contents.nativeBridgeDocs, "layer membership and pin-tier visibility", "native bridge contract doc documents native layer and pin-tier debug state");
